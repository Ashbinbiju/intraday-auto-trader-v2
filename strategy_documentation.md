# 📄 Intraday Bot Strategy Documentation
...
## 2. Selection Process (The Funnel) 🌪️
...
### 📉 Technical Profit Booking (Dynamic Exit)
...
*This logic is hardcoded in `indicators.py` and `main.py` but can be tuned via the **Settings Page** (Risk % and Limits).*
